...
After obtaining the best focus distance and best sharpness pair for each sample point, we first attempt to correct for points sampled at 

we first naively assume the entire patch exists at the same depth, thus generating a blocky depth map as in ~\ref{fig:initial-depth-map}. Then we processed each 

interpolate... mode... bilateral sharpen.. joint bilateral...
