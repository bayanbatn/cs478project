...
generated is not hundred percent accurate). We use the following equation to calculate the appropriate blur radius of a pixel, given
...
Since $s$ and $D$ are intrinsic camera constants, we are not interested in them. Furthermore, 
