...
\begin{eqnarray} 
R&=&s\frac{D}{2}[\frac{1}{f}-\frac{1}{f_{0}}], or
R&\propto&\frac{1}{f}-\frac{1}{f_{0}}
\end{eqnarray}
 
Since $s$ and $D$ are intrinsic camera constants, we are not interested in them. Furthermore, in our end application, we wish allow the users to
choose their degree of synthetic blur. Consequently, we do not require calibration to measure $D$ and $s$. 
